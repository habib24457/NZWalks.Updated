    ...
    public partial class Seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("30711259-7265-4794-af0d-be1057745b46"), "Medium" },
                    { new Guid("bd165a93-cc41-4d45-852a-26c6049b0411"), "Hard" },
                    { new Guid("d37fa264-31a4-4156-b010-13b52c4f6ee9"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Diffculties",
                keyColumn: "Id",
                keyValue: new Guid("30711259-7265-4794-af0d-be1057745b46"));

            migrationBuilder.DeleteData(
                table: "Diffculties",
                keyColumn: "Id",
                keyValue: new Guid("bd165a93-cc41-4d45-852a-26c6049b0411"));

            migrationBuilder.DeleteData(
                table: "Diffculties",
                keyColumn: "Id",
                keyValue: new Guid("d37fa264-31a4-4156-b010-13b52c4f6ee9"));
